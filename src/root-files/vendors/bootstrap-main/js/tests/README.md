...
2. Review the [Jasmine API Documentation](https://jasmine.github.io/pages/docs_index.html) and use the existing tests as references for how to structure your new tests.
